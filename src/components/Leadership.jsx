...
//           {/* Download button */}
//           <a
//             href='/LIST_OF_2026_STATE_OFFICERS.pdf'
//             download
//             className="inline-flex items-center gap-2.5 bg-[#008A44] hover:bg-[#006d35] text-white font-semibold text-sm px-5 py-3 rounded-xl transition-colors shrink-0 group"
//           >
...
//               className="w-full pl-9 pr-4 py-2.5 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#008A44]/30 focus:border-[#008A44] bg-gray-50 placeholder-gray-400 transition"
//             />
//           </div>
...
//                     key={officer.id}
//                     className={`
//                       transition-colors hover:bg-[#008A44]/5
//                       ${officer.id === 1 ? 'bg-[#e8f5ee] font-semibold' : i % 2 === 0 ? 'bg-white' : 'bg-gray-50/60'}
//                     `}
//                   >
//                     <td className="px-5 py-3.5 text-xs font-bold text-gray-400 text-center">{officer.id}</td>
//                     <td className="px-5 py-3.5 font-medium text-gray-800">{officer.designation}</td>
...
//             {filtered.length === 0 ? (
//               <div className="px-5 py-12 text-center text-gray-400 text-sm">No officers match your search.</div>
//             ) : filtered.map((officer, i) => (
//               <div
//                 key={officer.id}
